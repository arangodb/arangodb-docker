...
echo "${GITBRANCH}: git://github.com/arangodb/arangodb-docker@${RELEASE_VERSION} jessie/${GITTAG}" >> /tmp/docker_library_template
echo "${GITTAG}: git://github.com/arangodb/arangodb-docker@${RELEASE_VERSION} jessie/${GITTAG}" >> /tmp/docker_library_template
...
if grep -q latest /tmp/docker_library_template ; then
    ...
    echo "latest: git://github.com/arangodb/arangodb-docker@${RELEASE_VERSION} jessie/${GITTAG}" >> /tmp/docker_library_template
fi
